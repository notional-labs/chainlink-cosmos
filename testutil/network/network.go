...
func DefaultConfig() network.Config {
	...
	return network.Config{
		...
		AccountTokens:   sdk.TokensFromConsensusPower(100000000, sdk.DefaultPowerReduction),
		StakingTokens:   sdk.TokensFromConsensusPower(100000000, sdk.DefaultPowerReduction),
