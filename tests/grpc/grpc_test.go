...
//		Name:   info.GetName(),
//		Pub:    info.GetPubKey(),
//		Addr:   info.GetAddress(),func importKeyPair(t testing.TB, clientCtx client.Context, name string) *testAccount {
// 	info, err := clientCtx.Keyring.Key(name)
// 	require.NoError(t, err)
// 	cosmosPubKey, err := sdk.Bech32ifyPubKey(sdk.Bech32PrefixAccPub, info.GetPubKey())
// 	require.NoError(t, err)
// 	return &testAccount{
// 		Name:   info.GetName(),
// 		Pub:    info.GetPubKey(),
